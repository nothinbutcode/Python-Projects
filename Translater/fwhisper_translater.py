            ...
            try:
                ...
                if file_path:
                    ...
                    if transcription:
                        ...
                        # Allow user to choose target language for translation
                        target_lang = input("Enter target language (e.g., 'es' for Spanish): ").strip().lower()
                        # Translate the transcribed text to the target language
                        translated_text = self.translate_text(transcription, target_lang=target_lang)
                        if translated_text:
